#' @title EvaluationMeasures.FNR
#' @description FNR of prediction
#' @details False Negative Rate is Proportional of positives that predict as negative .
...
EvaluationMeasures.FNR = function(Real=NULL,Predicted=NULL,Positive=1,TP=NULL,TN=NULL,FP=NULL,FN=NULL)
{
  if (!is.null(Real))
  {

#' @title EvaluationMeasures.Precision
#' @description Precision of prediction
#' @details Precision is What fraction of positive predicted are real positive.
...
#' @export EvaluationMeasures.Precision
...
EvaluationMeasures.Precision = function(Real=NULL,Predicted=NULL,Positive=1,TP=NULL,TN=NULL,FP=NULL,FN=NULL)
{
  return(EvaluationMeasures.PPV(Real=Real,Predicted=Predicted,Positive=Positive,TP=TP,TN=TN,FP=FP,FN=FN))
}

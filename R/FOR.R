#' @title EvaluationMeasures.FOR
#' @description FOR of prediction
#' @details False Ommision Rate is What fraction of negative predicted are real positive.
#' @details By getting the predicted and real values or number of TP,TN,FP,FN return the False Omission Rate of model
#' @author Babak Khorsand
#' @export EvaluationMeasures.FOR
...
EvaluationMeasures.FOR = function(Real=NULL,Predicted=NULL,Positive=1,TP=NULL,TN=NULL,FP=NULL,FN=NULL)
{
  if (!is.null(Real))
  {
